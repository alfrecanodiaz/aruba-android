package py.com.aruba.profesionales.utils.alerts;
...
public class AlertGlobal {
    ...
    public static void showRetrofitError(Context context, ResponseBody responseBody) {
        ...
        String error = null;
        try {
            //Trataremos de mejorar el mensaje de error mas adelante...
            ...
            e.printStackTrace();
            AlertGlobal.showMessage(context, "Error", "Hubo un problema al tratar de procesar su solicitud. Por favor intente de nuevo mas tarde.");
        } catch (Exception e) {
            e.printStackTrace();
            AlertGlobal.showMessage(context, "Error", "Hubo un problema al tratar de procesar su solicitud. Por favor intente de nuevo mas tarde.");
        }
