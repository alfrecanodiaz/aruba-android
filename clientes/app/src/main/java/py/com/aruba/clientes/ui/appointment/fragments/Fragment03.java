...
public class Fragment03 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_schedule_03_confirm, container, false);
        ButterKnife.bind(this, view);
        activity = (AppointmentReservationActivity) getActivity();
        realm = GlobalRealm.getDefault();
        customLoading = new UtilsLoading(activity);
    ...
    public void initRecycler() {
        ...
        listAppointmentsRealm = realm.where(Appointment.class)
                .equalTo("status", Constants.APPOINTMENT_STATUS.CREATING)
        ...
        recyclerView.setAdapter(new AppointmentViewAdapter(activity, listAppointments));
    }
...
//                btnPaid.setVisibility(View.INVISIBLE);
    ...
    void onMethodPaidClicked(View view) {
...
//                btnPaid.setVisibility(View.VISIBLE);
    ...
    private boolean validateForm() {
        ...
        if (payment_type == 0) {
            AlertGlobal.showCustomError(activity, "Atención", "Por favor seleccione el tipo de pago");
            return true;
        }
...
//                AlertGlobal.showCustomError(activity, "Atención", "Por favor complete el campo 'cambio de'");
//                return true;
//            }
        }
        return false;
