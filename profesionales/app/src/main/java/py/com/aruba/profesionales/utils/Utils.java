...
import py.com.aruba.profesionales.ui.SplashActivity;
import py.com.aruba.profesionales.ui.auth.LoginActivity;
...
public class Utils {
    ...
    /**
     * Método para actualizar el token de firebase del usuario
     */
    public static void refreshToken(Context context) {
//        String token = SharedPreferencesUtils.getString(context, Constants.TOKEN);
//        String firebase_token = SharedPreferencesUtils.getString(context, Constants.FIREBASE_TOKEN);
//        new ProfileRequest(context).refreshToken(firebase_token, token);
//        sendDeviceData(context);
    }
    ...
    public static void removeExplode(AppCompatActivity activity, View view) {
    ...
    public static String getAvatar() {
        ...
        return (user != null) ? user.getAvatar() : Constants.DEFAULT_AVATAR;
    }
